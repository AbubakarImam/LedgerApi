...
public class DepositRequestValidatorTests
{
    ...
    {
        var errors = _validator.Validate(new DepositRequest("1000000001", 100m, null, "key-1"));
    ...
    {
        var errors = _validator.Validate(new DepositRequest(accountNumber!, 100m, null, "key-1"));
    ...
    {
        var errors = _validator.Validate(new DepositRequest("1000000001", 100m, null, idempotencyKey!));
    ...
    {
        var errors = _validator.Validate(new DepositRequest("1000000001", amount, null, "key-1"));
